...
public interface IProductPageProcessor
{
    ...
    /// The Result property on the task object returns parsed information in a instance of <see cref="BaseAuctionRecord"/>.
    /// </returns>
    ...
    Task<BaseAuctionRecord> ParseProductPage(HtmlDocument htmlDocument);
}
